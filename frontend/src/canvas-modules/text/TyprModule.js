                    ...
                    if (/url/i.test(cmd.fill)) {
                        ...
                        if (id) {
                            ...
                            if (gradient && gradient.tagName == 'linearGradient') {
                                var stops = []
                                var gradientTransform = readTrnf(gradient.getAttribute('gradientTransform') || window.getComputedStyle(gradient).getPropertyValue('gradientTransform') || [1, 0, 0, 1, 0, 0])
                                ...
                                parentGroups.forEach(parent => {
                                    var parentTransform = readTrnf(parent.getAttribute('transform') || window.getComputedStyle(parent).getPropertyValue('transform') || [1, 0, 0, 1, 0, 0])
                                ...
                                for (var i = 0, children = gradient.children; i < children.length; i++) {
                                    stops.push({
                                        'offset': children[i].getAttribute('offset') || window.getComputedStyle(children[i]).getPropertyValue('offset') || 0,
                                        'stop-color': children[i].getAttribute('stop-color') || window.getComputedStyle(children[i]).getPropertyValue('stop-color') || '#000000',
                                        'stop-opacity': children[i].getAttribute('stop-opacity') || window.getComputedStyle(children[i]).getPropertyValue('stop-opacity') || 1
                                    })
                                }
                                cmd.fill = {
                                    id: gradient.getAttribute('id') + Math.random() * (99999 - 11111) + 11111,
                                    type: gradient.tagName,
                                    gradientUnits: gradient.getAttribute('gradientUnits') || window.getComputedStyle(gradient).getPropertyValue('gradientUnits'),
                                    x1: gradient.getAttribute('x1') || window.getComputedStyle(gradient).getPropertyValue('x1') || 0,
                                    y1: gradient.getAttribute('y1') || window.getComputedStyle(gradient).getPropertyValue('y1') || 0,
                                    x2: gradient.getAttribute('x2') || window.getComputedStyle(gradient).getPropertyValue('x2') || 0,
                                    y2: gradient.getAttribute('y2') || window.getComputedStyle(gradient).getPropertyValue('y2') || 0,
                                ...
                                cmd.fill = {
                                    ...
                                    type: gradient.tagName,
                                    gradientUnits: gradient.getAttribute('gradientUnits') || window.getComputedStyle(gradient).getPropertyValue('gradientUnits'),
                                    cx: gradient.getAttribute('cx') || window.getComputedStyle(gradient).getPropertyValue('cx') || 0,
                                    cy: gradient.getAttribute('cy') || window.getComputedStyle(gradient).getPropertyValue('cy') || 0,
                                    fr: gradient.getAttribute('fr') || window.getComputedStyle(gradient).getPropertyValue('fr') || 0,
                                    fx: gradient.getAttribute('fx') || window.getComputedStyle(gradient).getPropertyValue('fx') || gradient.getAttribute('cx') || window.getComputedStyle(gradient).getPropertyValue('cx') || 0,
                                    fy: gradient.getAttribute('fy') || window.getComputedStyle(gradient).getPropertyValue('fy') || gradient.getAttribute('cy') || window.getComputedStyle(gradient).getPropertyValue('cy') || 0,
                                    r: gradient.getAttribute('r') || window.getComputedStyle(gradient).getPropertyValue('r') || 0,
                                    gradientTransform: gradientTransform,
                                    stops: stops
                                }
                            }
        ...
        function _toPath(nds, pth, parent) {
            for (var ni = 0; ni < nds.length; ni++) {
                ...
                if (tn == "g") {
                    ...
                    image.opacity = parseFloat(nd.getAttribute('opacity') || window.getComputedStyle(nd).getPropertyValue('opacity') || 1)
                    pth.images.push(image)
                } else if (tn == "path" || tn == "circle" || tn == "ellipse" || tn == "polygon") {
                    pth.cmds.push({
                        fill: nd.getAttribute('fill') || window.getComputedStyle(nd).getPropertyValue('fill') || '#000000',
                        opacity: nd.getAttribute('opacity') || window.getComputedStyle(nd).getPropertyValue('opacity') || 1,
                    })
                    var d;
