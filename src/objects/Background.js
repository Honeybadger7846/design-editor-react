...
export class BackgroundObject extends fabric.Rect {
    initialize(options) {
        super.initialize(Object.assign(Object.assign({}, options), { selectable: false, hasControls: true, hasBorders: false, lockMovementY: true, lockMovementX: true, strokeWidth: 0, evented: true, hoverCursor: 'default' }));
        return this;
    }
