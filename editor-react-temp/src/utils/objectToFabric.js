    ...
    [ObjectType.DYNAMIC_TEXT](item, options, inGroup) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const textOptions = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, baseOptions), { keyValues: keyValues ? keyValues : [], text: text ? text : 'Default Text', keys: keys ? keys : [] }), (textAlign && { textAlign })), (fontFamily && { fontFamily })), (fontSize && { fontSize })), (fontWeight && { fontWeight })), (charSpacing && { charSpacing })), (lineheight && { lineheight }));
    ...
    [ObjectType.DYNAMIC_IMAGE](item, options, inGroup) {
        return new Promise((resolve, reject) => {
            try {
                ...
                // @ts-ignore
                const element = new fabric.DynamicImage(Object.assign(Object.assign({}, baseOptions), { keys: item.keys, keyValues: keyValues ? keyValues : [] }));
                resolve(element);
            }
            catch (err) {
                reject(err);
