...
export class DynamicTextObject extends fabric.Textbox {
  ...
  getUpdatedTextLines() {
      ...
      const updatedTextLinesWithStyles = updatedTextLines.map(updatedTextLine => {
          ...
          return Object.assign(Object.assign({}, updatedTextLine), { lineStyles });
      });
      ...
      setTimeout(() => {
          ...
          textLines.forEach(textLine => {
              ...
              const linekeyBounds = params.map(param => {
                  const charBounds = this.__charBounds[textLine.lineIndex].map(cbs => (Object.assign(Object.assign({}, cbs), { top: lineHeight * textLine.lineIndex })));
                  ...
                  const charBound = Object.assign(Object.assign(Object.assign({}, charBoundMin), param), { shift, left: shift + charBoundMin.left, top: charBoundMin.top, width: charBoundMax.width + charBoundMax.left - charBoundMin.left, height: charBoundMin.height });
                  return charBound;
              });
  ...
  getCanvasBoundingClientRect() {
      ...
      const position = {
          left: canvasEl === null || canvasEl === void 0 ? void 0 : canvasEl.getBoundingClientRect().left,
          top: canvasEl === null || canvasEl === void 0 ? void 0 : canvasEl.getBoundingClientRect().top
      };
      return position;
  }
  triggerKeysMenu() {
  ...
  initialize(options) {
      const { text } = options, textOptions = __rest(options, ["text"]);
      this.keys = [];
      this.keysBounds = [];
      ...
      this.keyValues = updatedKeyValues;
      // @ts-ignore
      super.initialize(text, Object.assign(Object.assign({}, textOptions), { backgroundColor: 'rgba(255,255,255,0)', keyValues: updatedKeyValues, editable: false }));
      this.on('modified', () => {
...
DynamicTextObject.type = 'DynamicText';
