...
export class DynamicImageObject extends fabric.Rect {
    ...
    initialize(options) {
        ...
        super.initialize(Object.assign(Object.assign({}, options), { strokeWidth: 0, fill: '#ecf0f1' }));
        this.on('added', () => {
            this.canvas.on('mouse:move', e => {
                if (e.target === this) {
                    ...
                    if (pointer.x >= centerPoint.x - change &&
...
DynamicImageObject.type = 'DynamicImage';
