...
class ObjectToFabric {
    ...
    [ObjectType.STATIC_TEXT](item) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const textOptions = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, baseOptions), { text: text ? text : 'Default Text' }), (textAlign && { textAlign })), (fontFamily && { fontFamily })), (fontSize && { fontSize })), (fontWeight && { fontWeight })), (charSpacing && { charSpacing })), (lineheight && { lineheight }));
    ...
    [ObjectType.DYNAMIC_TEXT](item, params) {
        return new Promise((resolve, reject) => {
            try {
                const baseOptions = this.getBaseOptions(item);
                const metadata = item.metadata;
                ...
                const textOptions = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, baseOptions), { text: updatedText ? updatedText : 'Default Text' }), (textAlign && { textAlign })), (fontFamily && { fontFamily })), (fontSize && { fontSize })), (fontWeight && { fontWeight })), (charSpacing && { charSpacing })), (lineheight && { lineheight }));
                const element = new fabric.StaticText(textOptions);
                resolve(element);
            }
            catch (err) {
    ...
    [ObjectType.STATIC_IMAGE](item) {
        return new Promise(async (resolve, reject) => {
            try {
                const baseOptions = this.getBaseOptions(item);
                const src = item.metadata.src;
                const image = await loadImageFromURL(src);
                const element = new fabric.StaticImage(image, Object.assign(Object.assign({}, baseOptions), { cropX: 0, cropY: item.metadata.cropY }));
                resolve(element);
            }
            catch (err) {
                reject(err);
    ...
    [ObjectType.DYNAMIC_IMAGE](item, params) {
        return new Promise(async (resolve, reject) => {
            try {
                const baseOptions = this.getBaseOptions(item);
                ...
                const image = await loadImageFromURL(src);
                // @ts-ignore
                const element = new fabric.StaticImage(image, Object.assign(Object.assign({}, baseOptions), { 
                    // @ts-ignore
                    width: image.width, 
                    // @ts-ignore
                    height: image.height, cropX: 0, cropY: 0 }));
    ...
    getBaseOptions(item) {
        const { left, top, width, height, scaleX, scaleY, opacity, flipX, flipY, skewX, skewY, stroke, strokeWidth, animation, originX, originY, angle } = item;
