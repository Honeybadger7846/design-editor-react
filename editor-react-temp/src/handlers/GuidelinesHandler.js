...
class GuidelinesHandler extends BaseHandler {
    ...
    initAligningGuidelines(canvas) {
        var ctx = canvas.getSelectionContext(), aligningLineOffset = 5, aligningLineMargin = 4, aligningLineWidth = 1.5, aligningLineColor = '#e056fd', viewportTransform, zoom = canvas.getZoom();
