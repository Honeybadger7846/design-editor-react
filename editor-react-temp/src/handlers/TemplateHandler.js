...
class TemplateHandler extends BaseHandler {
    exportToJSON() {
        ...
        template.metadata = Object.assign(Object.assign({}, template.metadata), { animated });
        return template;
    }
    async importFromJSON(template) {
        ...
        this.handlers.frameHandler.setBackgroundColor(template.background && template.background.type === 'color' ? template.background.value : '#ffffff');
