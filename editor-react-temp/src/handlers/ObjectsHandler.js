                      ...
                      if (activeObject._objects) {
                          ...
                          activeObject._objects.forEach(object => {
                              if (property === 'metadata') {
                                  object.set('metadata', Object.assign(Object.assign({}, object.metadata), options['metadata']));
                              }
                              else {
                          ...
                          if (property === 'metadata') {
                              // @ts-ignore
                              activeObject.set('metadata', Object.assign(Object.assign({}, activeObject.metadata), options[property]));
                          }
                          else {
                              // @ts-ignore
                              activeObject.set(property, options[property]);
      ...
      this.pasteStyle = () => {
          ...
          if (activeObject && this.copyStyleClipboard) {
              if (activeObject.type === this.copyStyleClipboard.objectType) {
                  const _a = this.copyStyleClipboard.props, { fill } = _a, basicProps = __rest(_a, ["fill"]);
